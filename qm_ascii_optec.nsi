...
############################## Symbol Definitions ##############################
!define APP_NAME "Modbus Data Fetcher"
!system 'echo "!define VERSION" $(git describe | sed -e "s/^v//g") > version.nsh'
!include version.nsh
!define COMPANY "ILIT.RU"
!define WEBSITE "http://www.ilit.ru"
!define COPYRIGHT "© ilit.ru 2018-2019"
!define DESCRIPTION "Application with modbus ASCII slave client for data acqusition"
